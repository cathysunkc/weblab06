/****************** YOUR NAME: Cathy Sun King Chung
...
function changeDuration() {
    ...
    let spanDurationText = document.getElementById("duration-text");
    duration = window.prompt("Please input the duration in number:");
    spanDurationText.innerHTML = duration;
    recalculate();    
}
